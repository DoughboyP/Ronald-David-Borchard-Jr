...
UNIVERSE_STABILITY_THRESHOLD = 0.72   # Fraction [0,1] – below this, universe collapses
UNIVERSE_SENTIENCE_THRESHOLD = 0.85   # Fraction [0,1] – above this, life emerges

# Physical constants (scaled for simulation)
SIMULATED_PLANCK = 6.626e-34   # J·s
SIMULATED_SPEED_OF_LIGHT = 299_792_458  # m/s
SIMULATED_G = 6.674e-11        # N·m²/kg²

# Energy budget (arbitrary device units, "dU")
INITIAL_ENERGY_BUDGET = 1_000_000.0  # dU – starting energy for generation 0
ENERGY_SCALING_FACTOR = 1.618        # Each generation multiplies budget by golden ratio
UNIVERSE_CREATION_COST = 10_000.0    # dU – base cost to spawn one universe
SELF_BUILD_COST = 50_000.0           # dU – cost to run a self-build cycle

# Dimensional parameters
BASE_DIMENSIONS = 3            # Spatial dimensions for first-generation universes
MAX_DIMENSIONS = 11            # M-theory limit
DIMENSION_UNLOCK_GENERATION = 3  # Generation at which extra dimensions become available
